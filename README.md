...
```javascript
pkg2alias = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-pkg2alias@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/namespace-pkg2alias/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/namespace-pkg2alias/actions/workflows/test.yml?query=branch:v0.1.0
